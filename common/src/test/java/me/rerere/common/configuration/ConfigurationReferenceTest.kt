...
class ConfigurationReferenceTest {
    ...
    @Test
    fun `enterprise identity retains deployment and original resource id`() {
        val reference: ConfigurationReference = ConfigurationReference.Enterprise(
            EnterpriseAuthority("dep_example"), "mdl_chat",
        )
        val wire = "managed~dep_example~mdl_chat"
