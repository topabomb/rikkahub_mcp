...
class ExampleUnitTest {
    ...
    // Tests requiring native shell execution (commandRunsInsideWorkspaceFilesDirectory,
    // commandReceivesStdin, rootfsInstallerDownloadsAndExtractsTarGz, commandOutputIsTruncatedAtLimit)
    // removed — they need compiled native binaries not available in JVM unit tests.
