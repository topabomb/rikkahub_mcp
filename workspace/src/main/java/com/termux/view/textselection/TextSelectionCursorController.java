...
public class TextSelectionCursorController implements CursorController {
    ...
    public void show(MotionEvent event) {
        if (terminalView.isRetired() || terminalView.mEmulator == null) return;
    ...
    @Override
    public boolean hide() { return hide(false); }
    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                if (terminalView.isRetired() || terminalView.mEmulator == null || !isActive()) {
                ...
                switch (item.getItemId()) {
                    ...
                    case ACTION_MORE:
                        ...
                        terminalView.dispatchAction(() -> terminalView.showContextMenu());
                        break;
                }
