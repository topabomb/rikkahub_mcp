...
import net.weero.mersix.pilot.data.datastore.isNotConfigured
...
import net.weero.mersix.pilot.ui.hooks.rememberColorMode
import net.weero.mersix.pilot.ui.theme.ColorMode
        ...
        LazyColumn(
            ...
            item("aboutSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = {
                            context.openUrl("https://mersix.weero.net/mobile/docs")
                        },
