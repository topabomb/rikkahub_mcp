...
import net.weero.mersix.pilot.di.appModule
import net.weero.mersix.pilot.di.dataSourceModule
import net.weero.mersix.pilot.di.repositoryModule
import net.weero.mersix.pilot.di.viewModelModule
...
import net.weero.mersix.pilot.utils.DatabaseUtil
...
private const val TAG = "MersixPilotApp"

const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update"

class MersixPilotApp : Application() {
    override fun onCreate() {
        super.onCreate()
        startKoin {
            androidLogger()
            androidContext(this@MersixPilotApp)
            workManagerFactory()
