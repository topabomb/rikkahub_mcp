...
fun rememberSharedPreferenceString(
    ...
    val prefs = remember {
        context.getSharedPreferences("mersixpilot.preferences", Context.MODE_PRIVATE)
    }
    val stateFlow =
...
fun Context.writeStringPreference(key: String, value: String?) {
    getSharedPreferences("mersixpilot.preferences", Context.MODE_PRIVATE).edit {
        putString(key, value)
    }
}

fun Context.readStringPreference(key: String, defaultValue: String? = null): String? {
    return getSharedPreferences("mersixpilot.preferences", Context.MODE_PRIVATE).getString(key, defaultValue)
}
...
fun Context.readBooleanPreference(key: String, defaultValue: Boolean = false): Boolean {
    return getSharedPreferences("mersixpilot.preferences", Context.MODE_PRIVATE).getBoolean(key, defaultValue)
}
