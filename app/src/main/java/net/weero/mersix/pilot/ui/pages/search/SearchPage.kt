package net.weero.mersix.pilot.ui.pages.search
...
import net.weero.mersix.pilot.data.db.fts.MessageSearchResult
import net.weero.mersix.pilot.data.db.fts.MessageSearchSort
