package net.weero.mersix.pilot.data.datastore
...
import net.weero.mersix.pilot.data.ai.prompts.DEFAULT_COMPRESS_PROMPT
import net.weero.mersix.pilot.data.ai.prompts.DEFAULT_OCR_PROMPT
import net.weero.mersix.pilot.data.ai.prompts.DEFAULT_SUGGESTION_PROMPT
import net.weero.mersix.pilot.data.ai.prompts.DEFAULT_TITLE_PROMPT
import net.weero.mersix.pilot.data.ai.prompts.LEARNING_MODE_PROMPT
import me.rerere.asr.ASRProviderSetting
import net.weero.mersix.pilot.data.model.Assistant
import net.weero.mersix.pilot.data.model.Avatar
import net.weero.mersix.pilot.data.model.InjectionPosition
import net.weero.mersix.pilot.data.model.PromptInjection
import net.weero.mersix.pilot.data.model.QuickMessage
import net.weero.mersix.pilot.data.model.Tag
...
data class WebDavConfig(
    ...
    val username: String = "",
    val password: String = "",
    val path: String = "mersix_pilot_backups",
