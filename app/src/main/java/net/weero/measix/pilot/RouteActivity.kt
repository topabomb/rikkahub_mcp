...
import net.weero.measix.pilot.ui.pages.assistant.detail.AssistantExtensionsPage
import net.weero.measix.pilot.ui.pages.assistant.detail.AssistantLocalToolPage
import net.weero.measix.pilot.ui.pages.assistant.detail.AssistantMcpPage
import net.weero.measix.pilot.ui.pages.assistant.detail.AssistantMemoryPage
...
import net.weero.measix.pilot.ui.pages.extensions.QuickMessagesPage
import net.weero.measix.pilot.ui.pages.extensions.skills.SkillDetailPage
...
import net.weero.measix.pilot.ui.pages.imggen.ImageGenPage
import net.weero.measix.pilot.ui.pages.log.LogPage
import net.weero.measix.pilot.ui.pages.search.SearchPage
import net.weero.measix.pilot.ui.pages.setting.SettingAboutPage
import net.weero.measix.pilot.ui.pages.setting.SettingPreferencesPage
import net.weero.measix.pilot.ui.pages.setting.SettingPreferencesThemePage
import net.weero.measix.pilot.ui.pages.setting.SettingPreferencesNotificationPage
import net.weero.measix.pilot.ui.pages.setting.SettingPreferencesGeneralPage
import net.weero.measix.pilot.ui.pages.setting.SettingPreferencesUIPage
import net.weero.measix.pilot.ui.pages.setting.SettingThemePage
import net.weero.measix.pilot.ui.pages.setting.SettingFilesPage
import net.weero.measix.pilot.ui.pages.setting.SettingMcpPage
import net.weero.measix.pilot.ui.pages.setting.SettingModelPage
import net.weero.measix.pilot.ui.pages.setting.SettingPage
import net.weero.measix.pilot.ui.pages.setting.SettingProviderDetailPage
import net.weero.measix.pilot.ui.pages.setting.SettingProviderPage
import net.weero.measix.pilot.ui.pages.setting.SettingSearchDetailPage
import net.weero.measix.pilot.ui.pages.setting.SettingSearchPage
        ...
        LaunchedEffect(tts) {
            eventBus.events.collect { event ->
                when (event) {
                    ...
                    is AppEvent.ChatGenerationAwaitingApproval -> Unit // 由 ChatNotificationManager 消费
