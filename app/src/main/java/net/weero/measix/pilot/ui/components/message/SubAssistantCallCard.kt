...
internal fun localizeSubAssistantReason(reason: String): String {
    return when (reason) {
        ...
        "rate_limited" -> stringResource(R.string.error_title_rate_limited)
        "quota_exhausted" -> stringResource(R.string.error_title_quota_exhausted)
        "auth_failed" -> stringResource(R.string.error_title_auth_failed)
        "permission_denied" -> stringResource(R.string.error_title_permission_denied)
        "invalid_request" -> stringResource(R.string.error_title_invalid_request)
        "provider_unavailable" -> stringResource(R.string.error_title_provider_unavailable)
