...
/**
 * androidTest 共享的最小 canonical candidate 与 [TurnRequestContext] 构造（与
 * `app/src/test` 的 ModelContextTestSupport / TurnRequestContextFixtures 同源语义；
...
internal fun androidTestTurnRequestContext(
    settings: Settings,
    model: Model,
    assistant: Assistant,
